 ...
 *
 * ```typescript
 * import { Parser } from '#src/plugins/display/claude-code-ink/engine/termio.js'
 *
...
// Parser
export { Parser } from '#src/plugins/display/claude-code-ink/engine/termio/parser.js'
// Types
export type {
  Action,
  Color,
  ...
  TitleAction,
  UnderlineStyle,
} from '#src/plugins/display/claude-code-ink/engine/termio/types.js'
export { colorsEqual, defaultStyle, stylesEqual } from '#src/plugins/display/claude-code-ink/engine/termio/types.js'
