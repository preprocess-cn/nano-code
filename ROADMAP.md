...
| 3 | **配置校验** | ~3h | 载入 config.json 时做 schema 校验，及早发现拼写错误 |
...
| # | 功能 | 预估 | 说明 |
|---|------|------|------|
| 7 | **CI/CD** | ~3h | GitHub Actions + 自动测试 |
| 8 | **发布准备** | ~4h | package.json 补全、README 更新、npm publish |
| 9 | **插件权限系统** | ~3d | npm 插件的安全沙箱 + 权限声明机制 |
| 10 | **插件热加载** | ~2d | 运行时开关插件无需重启 |
